...
#define DEBUG_TYPE "random-scalarizer"

bool ClScalarizeVariableInsertExtract;

// This is disabled by default because having separate loads and stores
// makes it more likely that the -combiner-alias-analysis limits will be
// reached.
bool ClScalarizeLoadStore = true;
...
public:
  ScalarizerVisitor(DominatorTree *DT, ScalarizerPassOptions Options)
      : DT(DT),
        ScalarizeVariableInsertExtract(ClScalarizeVariableInsertExtract),
        ScalarizeLoadStore(ClScalarizeLoadStore),
        ScalarizeMinBits(ClScalarizeMinBits) {}
...
PreservedAnalyses RandomScalarizerPass::run(Function &F,
