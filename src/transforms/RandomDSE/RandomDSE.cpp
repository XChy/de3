...
bool EnablePartialOverwriteTracking = true;

bool EnablePartialStoreMerging = true;

unsigned MemorySSAScanLimit = 150;
unsigned MemorySSAUpwardsStepLimit = 90;

unsigned MemorySSAPartialStoreLimit = 5;

unsigned MemorySSADefsPerBlockLimit = 5000;

unsigned MemorySSASameBBStepCost = 1;

unsigned MemorySSAOtherBBStepCost = 5;

unsigned MemorySSAPathCheckLimit = 50;
...
// DSE Pass
//===----------------------------------------------------------------------===//
PreservedAnalyses RandomDSEPass::run(Function &F, FunctionAnalysisManager &AM) {
